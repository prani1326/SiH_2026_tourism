...
const upsertAvailabilityRef = (dcOrVars, vars) => {
...
exports.upsertAvailabilityRef = upsertAvailabilityRef;

exports.upsertAvailability = function upsertAvailability(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const addPropertyRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'AddProperty', inputVars);
}
addPropertyRef.operationName = 'AddProperty';
exports.addPropertyRef = addPropertyRef;

exports.addProperty = function addProperty(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
exports.listAllProperties = function listAllProperties(dcOrOptions, options) {
...
const getPropertyDetailsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetPropertyDetails', inputVars);
}
getPropertyDetailsRef.operationName = 'GetPropertyDetails';
exports.getPropertyDetailsRef = getPropertyDetailsRef;

exports.getPropertyDetails = function getPropertyDetails(dcOrVars, varsOrOptions, options) {
